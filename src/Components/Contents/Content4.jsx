    ...
    <div className="ContentComponent4">
      ...
      >
        <div >
          ...
          >
            <div style={{display:"flex",justifyContent:"space-between", backgroundColor:"rgb(250 249 250)",fontSize:"15px",borderBottom:"1px solid grey" }}>
              <div style={{padding:"10px"}}>
              <p style={{fontWeight:750,color:"rgb(40 13 95)"}}>Round</p>
              <span style={{fontSize:"11px",color:"rgb(40 13 95)"}}>Draw:Feb 3 , 2022 , 5:30 PM</span>
            
              </div>
              <div style={{padding:"10px"}}>
              <button
          scale="sm"
          style={{marginLeft:"5px",height:"24px",background:"white",border:"none",cursor:"pointer"}}
        >
          <svg
            viewBox="0 0 24 24"
            color="text"
        ...
        >
          ...
          >
            ...
            <div className="TicketText" style={{borderBottom:"1px solid grey",display:"flex",justifyContent:"space-between"}}>
              <div>
             ...
             <div style={{display:"flex",padding:"20px"}}>
               <p className="circle" style={{backgroundColor:"red"}}>2</p>
               <p className="circle" style={{backgroundColor:"green"}}>3</p>
               <p className="circle" style={{backgroundColor:"blue"}}>4</p>
               <p className="circle" style={{backgroundColor:"yellow"}}>5</p>
               <p className="circle" style={{backgroundColor:"grey"}}>6</p>
               <p className="circle" style={{backgroundColor:"purple"}}>7</p>
             </div>
            </div>
            ...
            {modalfooterCondition ? (
              ...
              <Button className="BTNDetails" onClick={handlingDetail}>
                {modalfooterCondition ? (
                  <p style={{ fontWeight: 1000 ,display:"flex",marginBottom:"20px"}}>Hide<ArrowUpwardOutlined style={{height:"18px"}}></ArrowUpwardOutlined></p>
                ) : (
                  <p style={{ fontWeight: 1000 ,display:"flex",marginBottom:"20px"}}>Details <ArrowDownwardOutlined style={{height:"18px"}}></ArrowDownwardOutlined></p>
                )}
              </Button>
